...
public class ProxyGenerator {
    ...
    public static <T> T newProxyInstance(ClassLoader classLoader, Class<T> targetClass, InvocationHandler invocationHandler)
            throws Exception {

        if (proxyInstanceCache.containsKey(targetClass)) {
            return (T) proxyInstanceCache.get(targetClass);
        }
